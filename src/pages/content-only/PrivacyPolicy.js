...
const PrivacyPolicy = () => {
  ...
  return (
    <ContentPage>
      <h2 className="section-heading-lower mt-4">Privacy and Cookie Policy:</h2>
      <h2 className="section-heading-upper mb-4">Theorymine Limited</h2>
      <ol>

        <li>Privacy and Cookie Policy

          <ol>
            <li>TheoryMine is Registered in Scotland as
